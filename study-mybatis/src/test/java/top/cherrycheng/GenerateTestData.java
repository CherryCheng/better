...
public class GenerateTestData {
    ...
    public void updateInfo() throws IOException {
        ...
        final String IDCardNumber = ChineseIDCardNumberGenerator.getInstance().generate();
...
//            }
    ...
    public static String getRandomWorkCompany() {
        ...
        int indexCity = (int) ((Math.random() * 1000) / 3);
        sb.append(city[indexCity > city.length - 1 ? city.length / 2 : indexCity]);
        sb.append("xxx");
        int indexComp = (int) ((Math.random() * 100) / 3);
        sb.append(company_suffixes[indexComp > company_suffixes.length - 1 ? company_suffixes.length / 2 : indexComp]);
        return sb.toString();
    }
